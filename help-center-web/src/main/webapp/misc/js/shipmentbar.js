var serverPage = '//jd2008.360buy.com/Service/ShipmentBarService.aspx';
...
function CloseObject(target) {
    ...
    this.url = ''; this.param = ''; this.process = function() {
        var js = document.createElement('script'); js.type = 'text/javascript'; js.src = '//jd2008.360buy.com/Service/ShipmentBarService.aspx?roid=' + Math.random() + '&' + this.param;
...
function showShipmentTypesDt(skuId) {
    ...
    var message = ""; var html = ""; if (obj != null) {
        if (obj.json != null) { obj = obj.json; } for (var i = 0; i < obj.length; i++) {
            if (obj[i].Id == "-1") {
                if (obj[i].Name == "djd" && message.indexOf("此商品属于大家电，只能选择“京东快递”或是“快递运输”;") == -1) { message += "此商品属于大家电，只能选择“京东快递”或是“快递运输”;"; } if (obj[i].Name == "weight") { message += "此商品重量大于10公斤，不适用于<a style='color:#0000A0;' target=\"_blank\" href=\"//www.360buy.com/help/kdexpress.aspx#kdmyf\">免运费规则</a>，请您谅解;"; }
